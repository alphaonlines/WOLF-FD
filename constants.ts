...
export const APP_VERSION = String((packageJson as { displayVersion?: string; version: string }).displayVersion || packageJson.version);
...
export const INITIAL_POSTS: SocialPost[] = [
  {
    ...
    platform: "Instagram",
    content:
      "Check out our new velvet sectional! It brings a touch of modern elegance to any living room. Available in Navy and Emerald. #FurnitureDistributors #InteriorDesign",
