...
function registerTrackingRoutes({ app, pool }) {
    const registerEventRoute = (routePath) => app.post(routePath, async (req, res) => {
        try {
    ...
    const registerSummaryRoute = (routePath) => app.get(routePath, async (req, res) => {
        try {
