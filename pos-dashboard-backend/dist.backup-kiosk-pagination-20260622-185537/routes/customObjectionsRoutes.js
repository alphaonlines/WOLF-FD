...
exports.registerCustomObjectionsRoutes = registerCustomObjectionsRoutes;
function mapCustomObjectionRow(row) {
    return {
        id: Number(row.id),
...
function registerCustomObjectionsRoutes(app, pool) {
...
//# sourceMappingURL=customObjectionsRoutes.js.map