...
exports.ROLE_DEFAULT_PERMISSION_KEYS = exports.PERMISSION_CATALOG = void 0;
exports.normalizePermissionKeyList = normalizePermissionKeyList;
exports.isValidPermissionKey = isValidPermissionKey;
exports.getRoleDefaultPermissionKeys = getRoleDefaultPermissionKeys;
exports.PERMISSION_CATALOG = [
    ...
    {
        key: "feature.shop_kiosk_image_approval",
        label: "Feature: Shop Kiosk Image Approval",
        scope: "feature",
        description: "Allow reviewing and approving pending AlphaOS Kiosk product image candidates.",
    },
];
const ownerDefaults = exports.PERMISSION_CATALOG.map((entry) => entry.key);
exports.ROLE_DEFAULT_PERMISSION_KEYS = {
    Owner: ownerDefaults,
    Manager: [
        "module.dashboard",
        "module.sales",
        ...
        "module.amp",
        "module.shop",
        ...exports.PERMISSION_CATALOG.filter((e) => e.scope === "dashboard_card").map((e) => e.key),
...
const VALID_PERMISSION_KEYS = new Set(exports.PERMISSION_CATALOG.map((entry) => entry.key));
function normalizePermissionKeyList(raw) {
...
function getRoleDefaultPermissionKeys(roleKey) {
    return exports.ROLE_DEFAULT_PERMISSION_KEYS[roleKey] || [];
}
